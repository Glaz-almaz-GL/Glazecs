...
{
    /// <summary>
    /// Правило удаления XML-документационных комментариев из C# кода.
    /// </summary>
    public sealed class CSharpDocumentationCommentRemovalRule(
        ILogger<CSharpDocumentationCommentRemovalRule>? logger,
